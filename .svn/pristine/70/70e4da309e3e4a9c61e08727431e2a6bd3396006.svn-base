...
(function(global, factory) {
    ...
    hivideo.prototype = {
        ...
        init: function(ele) {
            ...
            this.pause = () => {
                this.video.pause();
                this.videoPlayIcon && this.exchangeBtnStatus(this.videoPlayIcon, true);
                this.playBtn && this.exchangeBtnStatus(this.playBtn, true);
            }
            return this;
        },
        config: function() {
    ...
    hivideo.prototype.bindPlayEvent = function() {
        var self = this;
        [self.playBtn, self.videoPlayIcon, self.video].forEach(function(ele) {
