/*----------------------------------------后台Api地址----------------------------------------*/
export const APP_SERVE_URL = 'http://47.97.60.28:8000/api/v1/';
export const APP_SERVE_URL2 = 'http://47.97.60.28:8000/api/v2/';
/*----------------------------------------websocket地址----------------------------------------*/
export const SOCKET_SERVE_URL = 'ws://www.shangjin666.cn:4649/';
/*----------------------------------------图片地址ip-----------------------------------------*/
